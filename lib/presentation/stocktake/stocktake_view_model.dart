...
class StockTakeViewModel extends StateNotifier<StockTakeState> {
  ...
  Future<void> loadStockTakes() async {
    ...
    final result = mockStockTakes;
    // await repository.getAllStockTakes();

    // result.fold(
    //   (failure) =>
    //       state = state.copyWith(isLoading: false, error: failure.message),
    //   (stockTakes) =>
          state = state.copyWith(isLoading: false, stockTakes: result);
  }
  Future<void> refresh() async => loadStockTakes();
