...
class _UnitApi implements UnitApi {
  ...
  Future<List<UnitModel>> getAllUnits() async {
    ...
    final _options = _setStreamType<List<UnitModel>>(
  ...
  Future<UnitModel> getUnitById(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UnitModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/units/${id}',
    ...
    late UnitModel _value;
    try {
      _value = UnitModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<List<UnitModel>> searchUnits(String query) async {
    final _extra = <String, dynamic>{};
