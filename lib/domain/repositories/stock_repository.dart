...
abstract class StockRepository {
  ...
  Future<Either<Failure, void>> updateStockStatus(String id, StockStatus status);
  Future<Either<Failure, void>> updateMultipleStockStatus(
      List<String> ids, StockStatus status);

  Future<Either<Failure, void>> adjustStock(
      String stockId, int adjustment, String reason);
}
